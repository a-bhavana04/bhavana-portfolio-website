  ...
  const projects = [
    {
      title: "RaftStream",
      description:
        "Distributed video processing platform with RAFT consensus and failover recovery.",
    ...
    },
    {
      title: "AlgoJudge",
      description:
        "AI-powered coding judge with sandboxed execution, optimization feedback, and complexity analysis.",
      tech: ["Next.js", "FastAPI", "Docker", "PostgreSQL", "AWS", "Phi-4 LLM"],
      link: "https://github.com/a-bhavana04/AlgoJudge",
    },
    {
      title: "WebGPU ML Bench",
      description:
        "Browser-based GPU benchmarking suite with custom WGSL kernels for ML ops like matmul and softmax.",
      tech: ["WebGPU", "TypeScript", "WGSL", "React", "Vite"],
      link: "https://github.com/a-bhavana04/webgpu-ml-bench",
    },
    {
      title: "Arthanithi (App)",
      description:
        "Micro-investment platform with spare-change auto-investing and RL-based portfolio management.",
    ...
    },
    {
      title: "SheStrides",
      description:
        "Women’s safety app with ARCore overlays and personalized route guidance.",
    ...
    },
    {
      title: "EquiGo",
      description:
        "Resilient navigation app using dual-LLMs for reliable routes over unstable networks.",
    ...
    },
    {
      title: "DermaMVQA",
      description:
        "Multimodal QA for dermatology combining Graph-RAG, CLIP, BioBERT, and medical knowledge graphs.",
    ...
    },
    {
      ...
      description:
        "Processed 8K+ arXiv abstracts with TF-IDF, PCA, and clustering to build a semantic recommender.",
    ...
    },
    {
      title: "DigiWe",
      description:
        "Speech-driven assistive app for new tech users and elderly, with edge computing and Whisper AI.",
    ...
    },
    {
      title: "EasyLexi",
      description:
        "Assistive reading tool for dyslexic users with OCR, speech-to-text, and correction overlays.",
